...
#define HD44780_RW_BIT								GPIO_PIN_3

/* EN_BIT was PIN_2 but PB2 doesn't appear on the pinout of the
 * Nucleo-32 board. - R. Hofer
 */
#define HD44780_EN_BIT								GPIO_PIN_1

/* defines the peripheral clocks that need to be enabled for the above pins */
//#define HD44780_RCC_AHBPeriph					RCC_AHBPeriph_GPIOD
//or something like "RCC_AHBPeriph_GPIOA | RCC_AHBPeriph_GPIOD"
...
#define hd44780_RS_On()		            HAL_GPIO_WritePin(HD44780_CONTROLPORT, HD44780_RS_BIT, Bit_SET)
#define hd44780_RS_Off()	           	HAL_GPIO_WritePin(HD44780_CONTROLPORT, HD44780_RS_BIT, Bit_RESET)
#define hd44780_RW_On()		            HAL_GPIO_WritePin(HD44780_CONTROLPORT, HD44780_RW_BIT, Bit_SET)
#define hd44780_RW_Off()	            HAL_GPIO_WritePin(HD44780_CONTROLPORT, HD44780_RW_BIT, Bit_RESET)
#define hd44780_EN_On()		            HAL_GPIO_WritePin(HD44780_CONTROLPORT, HD44780_EN_BIT, Bit_SET)
#define hd44780_EN_Off()	            HAL_GPIO_WritePin(HD44780_CONTROLPORT, HD44780_EN_BIT, Bit_RESET)

/* the original library delays
...
now changed to use HAL_DELAY() - R. Hofer */
#define hd44780_EN_high_delay()     	HAL_Delay(2) 	//(spec'd as 450ns from datasheet.)
														//tried 1 but did not work on LCD
#define hd44780_init_delay()        	HAL_Delay(16)	//16ms
#define hd44780_init_delay2()       	HAL_Delay(5)	//5ms
#define hd44780_init_delay3()       	HAL_Delay(1)	//1ms
#define hd44780_init_end_delay()    	HAL_Delay(2)	//2ms
